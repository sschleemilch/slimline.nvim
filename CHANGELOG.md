...
- `spaces.padding` configuration to configure content padding when using `bg` style to have a more compact line

## [2.10.0] - 2026-04-08

### Added

- `git`: new branch provider: [mini.git](https://github.com/nvim-mini/mini-git)

## [2.9.0] - 2026-02-28

### Changed

- Removed git CLI fallback for branch. Costs too much performance to call every refresh

### Fixed

- Possibly missing attached LSPs when lazy loading plugin
- nil augroup in Colorscheme auto command
- optimized get_mode()
...
- `git`: possible number and nil comparison

## [2.8.0] - 2025-12-03

### Added

- `git`: new diff provider: [vim-gitgutter](https://github.com/airblade/vim-gitgutter)
- `filetype`: new icon provider: [nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons)
