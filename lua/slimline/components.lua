...
--- @return string
function M.path()
  local file = highlights.highlight_content(" " .. vim.fn.expand("%:t") .. " %m%r", highlights.hls.primary.text,
    config.sep.left)
...
function M.diagnostics()
  ...
  last_diagnostic_component = highlights.highlight_content(" " .. last_diagnostic_component .. " ",
    highlights.hls.primary.text, config.sep.left, config.sep.right)
  return last_diagnostic_component
end
...
function M.filetype_lsp()
  ...
  filetype = highlights.highlight_content(" " .. icon .. " " .. filetype .. " ", highlights.hls.primary.text, nil,
    config.sep.right)
