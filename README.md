...
| git            | Branch and Diff infos (requires [gitsigns](https://github.com/lewis6991/gitsigns.nvim), [mini.git](https://github.com/nvim-mini/mini-git) (branch only), [mini.diff](https://github.com/nvim-mini/mini.diff) (diff only), [vim-gitgutter](https://github.com/airblade/vim-gitgutter) (diff-only) or [vim-fugitive](https://github.com/tpope/vim-fugitive) (branch only). |
...
- [gitsigns](https://github.com/lewis6991/gitsigns.nvim),  [mini.git](https://github.com/nvim-mini/mini-git) (branch only), [mini.diff](https://github.com/nvim-mini/mini.diff) (diff only), [vim-gitgutter](https://github.com/airblade/vim-gitgutter) (diff-only) or [vim-fugitive](https://github.com/tpope/vim-fugitive) (branch only) if you want the `git` component. Otherwise, it will not be rendered
